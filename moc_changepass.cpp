...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "ChangePass\0on_pushButton_clicked\0"
};
...
const QMetaObject ChangePass::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ChangePass.data,
      qt_meta_data_ChangePass,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ChangePass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChangePass.stringdata0))
        return static_cast<void*>(const_cast< ChangePass*>(this));
